...
Consider the binary tree shown in figure \ref{figure 1}.

![\label{figure 1} A binary tree](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/binary-tree.pu)
...
![\label{figure 2} In-order traversal of a binary tree](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/binary-tree-in-order-traversal.pu)

-----

![\label{figure 3} Pre-order traversal of a binary tree](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/binary-tree-pre-order-traversal.pu)

-----

![\label{figure 4} Post-order traversal of a binary tree](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/binary-tree-post-order-traversal.pu)
...
![\label{figure 5} An intrusive list](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/intrusive-list.pu)

-----

An intrusive list is one where the items contained in the list themselves have the next pointers as shown in figure \ref{figure 5} where the `value` member and `next` member are both in the nodes.

![\label{figure 6} A non-intrusive list](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/non-intrusive-list.pu)
...
A binary tree is a fairly easy concept to understand once linked lists are understood. Instead of a next pointer in each node, the node contains a left pointer and right pointer. The more general case is a m-ary tree which has instead of just 2 children, has m children. Each node might consist of a parent pointer and an array of children pointers such as in figure \ref{figure 7}.

![\label{figure 7} A tree node](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/tree-node.pu)
...
![\label{figure 8} A better intrusive tree node](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/intrusive-tree-node.pu)

-----

If we recall our earlier tree example in figure \ref{figure 1}, when rearranged in this way it would appear as below in figure \ref{figure 9} using this alternative representation.

![\label{figure 9} An intrusive tree](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/intrusive-tree.pu)
...
![\label{figure 11} Tree as a table](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/table-1.pu)

----

The references should be indexes in to the array. Lets change those.

![\label{figure 12} Tree table with illustrative indexes](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/table-2.pu)
...
![\label{figure 13} Tree table with swapped entries](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/table-3.pu)
...
![\label{figure 14} Tree table with removed entry](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/table-4.pu)
...
![\label{figure 14} Tree table with free list](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/table-5.pu)
...
We call this a structure of arrays. This is in contrast to an array of structures which is the more regular approach. Figures \ref{figure 15} and \ref{figure 16} illustrate the layout of each.

![\label{figure 16} Array Of Structures](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/array-of-structures.pu)

-----

![\label{figure 17} Structure Of Arrays](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/JohnRyland/DataStructures/main/images/structure-of-arrays.pu)
